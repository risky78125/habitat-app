...
Component({
  data: {
    ...
    version: APP_VERSION,
    features: [
      { icon: '🤖', title: '多样的 AI Agent', desc: '提供多种专业领域的 AI 助手' },
      { icon: '💬', title: '深度对话', desc: '支持多轮对话，理解上下文' },
      { icon: '📊', title: '智能报告', desc: '基于对话内容生成专业报告' },
      { icon: '⚡', title: 'Token 经济', desc: '灵活的 Token 系统，签到获取' },
    ],
    links: [
